                ...
                <div className='space-y-6 pb-12 '>
                    ...
                    <div className='flex lg:flex-row flex-col items-center lg:gap-22 gap-5'>
                        ...
                        <div className='flex lg:gap-2 gap-5'>
                            <img src={Bkash} alt="" className='lg:w-[42px] w-full  lg:h-7 ' />
                            <img src={Visa} alt="" className='lg:w-[42px] w-full lg:h-7'  />
                            <img src={Mastercard} alt="" className='lg:w-[42px] w-full lg:h-7'  />
                            <img src={Nagad} alt="" className='lg:w-[42px] w-full lg:h-7'  />
                        </div>
                    <div className='flex gap-5'>
                        <input type="Checkbox" name="" id="" className=' size-5' />
