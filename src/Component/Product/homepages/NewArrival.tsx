    ...
    <div className='Wrapper'>
        ...
        <div className='py-24'>
                       <div className='w-[24.813rem] h-[6.438rem] text-start ' >
                        ...
                        <div className='font-poppins font-semibold text-[16px] leading-5 text-[#db4444]'> Featured</div>  
                        </div> 
                        <div className='py-3 font-inter font-semibold  text-[2.25rem] leading-12 tracking-[4%]'>New Arrival</div>
                        </div>  
...
<div className="relative w-162.5 h-150 bg-black rounded-xl overflow-hidden">
  ...
  <div className="absolute left-6 bottom-10 text-white">
    <h2 className="text-2xl font-semibold tracking-[3%]">PlayStation 5</h2>
...
<div className="relative w-162.5 h-71 bg-black rounded-xl overflow-hidden">
  ...
  <div className="absolute left-6 bottom-10 text-white">
    <h2 className="text-2xl font-semibold tracking-[3%]">Women’s Collections</h2>
...
<div className="relative w-[19.375rem] h-[17.75rem] bg-black rounded-xl overflow-hidden">
  ...
  <img src={Bt_Speaker} alt="" className='max-w-[27rem] mt-12 ml-12 '/>

 
  <div className="absolute left-6 bottom-10 text-white">
    <h2 className="text-2xl font-semibold tracking-[3%]">Speakers</h2>
...
<div className="relative w-[19.375rem] h-[17.75rem] bg-black rounded-xl overflow-hidden">
  ...
  <img src={Perfume} alt="" className='max-w-[27rem] mt-12 ml-12 '/>

 
  <div className="absolute left-6 bottom-10 text-white">
    <h2 className="text-2xl font-semibold tracking-[3%]">Perfume</h2>
...
<div className='flex gap-24 items justify-center'>

     </div>   
       <div className='my-12 flex gap-22 items-center justify-center'>
